...
class SocialTopologicalOccupationCostGrid:
    ...
    def _compute_social_costmap_for_entities(self, world, entities_uids, rp, restrict_4_neighbors=True):
        ...
        prev_set = cur_set
        while cur_set:
            rp.publish_grid_map(final_array / float(self.decimals_multiplicator / 100), world.dd)
