...
def check_new_local_opening(
    ...
    new_obtacle_inflated_by_robot_diameter = t.cast(Polygon,new_obstacle_polygon.buffer(
        2.0 * robot_radius, join_style=JOIN_STYLE.mitre
    ))
    new_obstacle_inflated_by_robot_radius = t.cast(Polygon, new_obstacle_polygon.buffer(
