...
class State:
    def __init__(
        ...
        *,
        ...
        goal_state_grid: npt.NDArray[np.float_],
        robot_pose: PoseModel,
        normalized_robot_pose: npt.NDArray[np.float_],
        goal_pose: npt.NDArray[np.float_],
        normalized_goal_pose: npt.NDArray[np.float_],
        goal_reached: bool,
    ):
        self.grid = grid
