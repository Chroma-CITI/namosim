...
class AfterTheFeastTest(unittest.TestCase):
    ...
    def test_stilman_2005_behavior_complexified(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_snamo(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_snamo.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_snamo_r2g2(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_snamo_r2g2.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_snamo(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_snamo.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_snamo(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_snamo.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_random_goal_reset(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_random_goal_reset.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_random_goal_reset_snamo(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_random_goal_reset_snamo.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_random_goal_no_reset(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_random_goal_no_reset.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_complexified_random_goal_no_reset_snamo(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_random_goal_no_reset_snamo.json"
        )
        sim.run()

    def test_stilman_2005_behavior_complexified_random_goal_no_reset_namo_simple_then_snamo(
        self
    ):
        ...
        sim_snamo = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_complexified_random_goal_no_reset_snamo.json",
            goals=sim_namo_report["temp_goals"],
            timestring=timestring,
        )
        sim_snamo.run()
    ...
    def test_for_2_hours(self):
        ...
        while (now_time - start_time) < (8.0 * 60.0 * 60.0):
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_random_goal_reset(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_random_goal_reset.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_random_goal_no_reset(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_random_goal_no_reset.json"
        )
        sim.run()

    def test_stilman_2005_behavior_multi_robots_complexified_random_goal_reset_snamo(
        self
    ):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_random_goal_reset_snamo.json"
        )
        sim.run()

    def test_stilman_2005_behavior_multi_robots_complexified_random_goal_no_reset_snamo(
        self
    ):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_random_goal_no_reset_snamo.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_conflict_middle(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_conflict_middle.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_conflict_02(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_conflict_02.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_multi_robots_complexified_4_robots(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "stilman_2005_behavior_multi_robots_complexified_4_robots.json"
        )
        sim.run()
    ...
    def test_stilman_2005_behavior_replay_complexified_random(self):
        sim = Simulator(
            simulation_file_path=self.path_to_folder
            + "variations-stilman_2005_behavior_complexified_random_goal_no_reset_snamo/2021-02-09-23h17m30s_143832/stilman_2005_behavior_complexified_random_goal_no_reset_snamo.json"
        )
        sim.run()
